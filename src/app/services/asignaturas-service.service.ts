import { RecorrerAsignaturaInterfaz } from './../utils/RecorrerAsignaturaInterfaz';
import { Injectable } from '@angular/core';
import { RecorrerCursosInterfaz } from '../utils/RecorrerCursoInterfaz';

@Injectable({
  providedIn: 'root'
})
export class AsignaturasServiceService {

  filtrado:string="";
  detalleCicloFiltrado: RecorrerCursosInterfaz[]=[];
  Filtrado: RecorrerAsignaturaInterfaz[]=[];
  detalleFiltrado: RecorrerAsignaturaInterfaz[]=[];
  ...
  constructor() {
   ...
   getFitlradoDefecto(): RecorrerAsignaturaInterfaz[]{
    return this.asignatura;
   }

   getFiltro():RecorrerAsignaturaInterfaz[]{
    return this.Filtrado;
   }
   setFiltro(Filtrado:RecorrerAsignaturaInterfaz[]){
    return this.Filtrado=Filtrado;
   }

   getDetalle():RecorrerAsignaturaInterfaz[]{
    return this.detalleFiltrado;
   }
   setDetalle(deatalleFiltrado:RecorrerAsignaturaInterfaz[]){
    return this.detalleFiltrado=deatalleFiltrado;
   }

   getInterfaz():RecorrerAsignaturaInterfaz[]{
    return this.asignatura;
   }

   getInterfazCiclos():RecorrerCursosInterfaz[]{
    return this.ciclo;
   }
   setInterfazCiclos(ciclo:RecorrerCursosInterfaz[]){
